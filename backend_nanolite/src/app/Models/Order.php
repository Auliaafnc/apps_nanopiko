...
class Order extends Model
{
    ...
    protected static function hitungProgramDanReward(Order $order): void
    {
        ...
        // jumlah_program hanya kalau customer ikut program
        $order->jumlah_program = !empty($order->customer_program_id) ? $units : 0;

        // reward_point selalu dapat
        $order->reward_point = $units;
    }
